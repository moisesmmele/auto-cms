...
export default {
  ...
  methods: {
    ...
    openModal(mode, chassisItem = null) {
      this.mode = mode;
      this.selectedChassisItem = chassisItem;
      this.showModal = true;
...
<template>
  <main class="bg-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div class="bg-secondary text-white rounded-t-md p-4 flex items-center justify-between">
        <div class="flex items-center gap-4">
          <h1 class="text-2xl font-bold">Carrocerias</h1>
      ...
      <div class="overflow-x-auto">
        <table class="min-w-full bg-white">
          ...
          <tr class="bg-gray-200 border-b border-b-gray-300">
            ...
            <th class="py-3 px-4 text-center font-medium text-gray-600">Carroceria</th>
            <th class="py-3 px-4 text-center font-medium text-gray-600">Ações</th>
          </tr>
          </thead>
          <!-- Table body -->
          <tbody>
          <tr v-for="item in chassis" :key="item.id" class="border-t bg-gray-200 border-t-gray-300 hover:bg-gray-300">
            ...
            <td class="py-3 px-4 flex justify-center space-x-3">
              ...
              <button @click="this.delete('chassis', item.id)" class="text-secondary">
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-5 w-5"
                    fill="none"
    ...
    <GenericModal
        v-if="showModal"
        :id="selectedChassisItem?.id"
        :label="selectedChassisItem?.label || ''"
        :resource="'chassis'"
        :title="'Carroceria'"
