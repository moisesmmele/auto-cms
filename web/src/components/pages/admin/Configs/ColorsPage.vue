    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div class="overflow-x-auto">
        <table class="min-w-full bg-white">
          ...
          <!-- Table body -->
          <tbody>
          <tr v-for="item in colors" :key="item.id" class="border-t bg-gray-200 border-t-gray-300 hover:bg-gray-300">
            ...
            <td class="py-3 px-4 flex justify-center space-x-3">
              ...
              <button @click="this.delete('colors', item.id)" class="text-secondary">
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-5 w-5"
                    fill="none"
