...
export default {
  ...
  beforeMount() {
    ...
    fetch('http://localhost:8083/colors', request)
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div class="bg-secondary text-white rounded-t-md p-4 flex items-center justify-between">
        <div class="flex items-center gap-4">
          <h1 class="text-2xl font-bold">Cores</h1>
      ...
      <div class="overflow-x-auto">
        <table class="min-w-full bg-white">
          ...
          <tr class="bg-gray-200 border-b border-b-gray-300">
            ...
            <th class="py-3 px-4 text-center font-medium text-gray-600">Cor</th>
            <th class="py-3 px-4 text-center font-medium text-gray-600">Ações</th>
          </tr>
          </thead>
          <!-- Table body -->
          <tbody>
          <tr v-for="colorsItem in colors" :key="colorsItem.id" class="border-t bg-gray-200 border-t-gray-300 hover:bg-gray-300">
            <td class="py-3 px-4 text-gray-700 text-center">{{ colorsItem.id }}</td>
            <td class="py-3 px-4 text-gray-700 text-center">{{ colorsItem.label }}</td>
