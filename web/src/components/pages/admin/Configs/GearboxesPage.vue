...
export default {
  ...
  computed: {
    ...
    results: function () {
      return this.transmissions.length
    }
  ...
  beforeMount() {
    ...
    fetch('http://localhost:8083/gearboxes', request)
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div class="bg-secondary text-white rounded-t-md p-4 flex items-center justify-between">
        <div class="flex items-center gap-4">
          <h1 class="text-2xl font-bold">Transmissões</h1>
        ...
        <div class="flex items-center gap-3">
          ...
          <button
              class="bg-primary text-secondary font-medium py-2 px-4 rounded-md transition-transmissions"
          >
            Novo
          </button>
        </div>
      ...
      <div class="overflow-x-auto">
        <table class="min-w-full bg-white">
          ...
          <tr class="bg-gray-200 border-b border-b-gray-300">
            ...
            <th class="py-3 px-4 text-center font-medium text-gray-600">Transmissão</th>
            <th class="py-3 px-4 text-center font-medium text-gray-600">Ações</th>
          </tr>
          </thead>
          <!-- Table body -->
          <tbody>
          <tr v-for="transmissionItem in transmissions" :key="transmissionItem.id" class="border-t bg-gray-200 border-t-gray-300 hover:bg-gray-300">
            <td class="py-3 px-4 text-gray-700 text-center">{{ transmissionItem.id }}</td>
            <td class="py-3 px-4 text-gray-700 text-center">{{ transmissionItem.label }}</td>
