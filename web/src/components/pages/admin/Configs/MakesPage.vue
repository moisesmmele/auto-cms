    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div class="overflow-x-auto">
        <table class="min-w-full bg-white">
          ...
          <!-- Table body -->
          <tbody>
          <tr v-for="makesItem in makes" :key="makesItem.id" class="border-t bg-gray-200 border-t-gray-300 hover:bg-gray-300">
            <td class="py-3 px-4 text-gray-700 text-center">{{ makesItem.id }}</td>
