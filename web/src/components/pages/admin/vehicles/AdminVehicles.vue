...
export default {
  ...
  methods: {
    ...
    fetchResource(resource) {
      ...
      fetch(`${import.meta.env.VITE_API_URL}/${resource}`, {
        method: "GET",
        headers
      })
          .then(res => res.json())
      ...
      <div class="overflow-x-auto">
        <table class="min-w-full bg-white">
          ...
          <tr class="bg-gray-200 border-b border-b-gray-300">
            ...
            <th class="py-3 px-4 text-center font-medium text-gray-600">Marca</th>
            <th class="py-3 px-4 text-center font-medium text-gray-600">Modelo</th>
            <th class="py-3 px-4 text-center font-medium text-gray-600">Ano</th>
